...
// Endpoint: obtener departamentos y ciudades (desde API de Interrapidísimo)
...
server.listen(PORT, () => {
  console.log(`Servidor cotizador en http://localhost:${PORT}`);
  console.log('  GET  /api/ciudades  (carga las 1471 ciudades de Interrapidísimo)');
  console.log('  POST /api/cotizar');
